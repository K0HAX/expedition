...
# Install all Apache required modules
    ...
    apt-mark hold php-common php-radius php7.0-bcmath php7.0-bz2 php7.0-cli php7.0-common php7.0-curl php7.0-gd php7.0-json
    apt-mark hold php7.0-ldap php7.0-mbstring php7.0-mcrypt php7.0-mysql php7.0-opcache php7.0-readline php7.0-soap
    apt-mark hold php7.0-xml php7.0-zip php7.0 php7.0-common php7.0-radius
